...
Route::get('/redirect/named', function (){
        //    return route('redirect-hello', ['name' => 'Gusti']);
        //    return url()->route('redirect-hello', ['name' => 'Gusti']);
            return \Illuminate\Support\Facades\URL::route('redirect-hello', ['name' => 'Gusti']);
});
Route::get('/redirect/action',[\App\Http\Controllers\RedirectController::class, 'redirectAction']);
Route::get('/redirect/away',[\App\Http\Controllers\RedirectController::class, 'redirectAway']);

Route::middleware(['contoh:HOFi,401'])->prefix('/middleware')->group(function (){
